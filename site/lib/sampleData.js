...
export const SAMPLE_VPN_STATUS = 'connected · 8ms';

// cfg.repoCount has no source wired up yet — a plausible stand-in for the header KPI.
export const SAMPLE_REPO_COUNT = 14;
